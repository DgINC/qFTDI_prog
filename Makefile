#############################################################################
# Makefile for building: qFTDI_prog
# Generated by qmake (3.0) (Qt 5.7.1)
# Project:  ../qFTDI_prog/qFTDI_prog.pro
# Template: app
# Command: /usr/bin/qmake-qt5 -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ../qFTDI_prog/qFTDI_prog.pro
#############################################################################
...
INCPATH       = -I../qFTDI_prog -I. -isystem /usr/include/libftdi1 -isystem /usr/include/libusb-1.0 -isystem /usr/include/qt5 -isystem /usr/include/qt5/QtWidgets -isystem /usr/include/qt5/QtGui -isystem /usr/include/qt5/QtCore -I. -I. -I/usr/lib64/qt5/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = qFTDI_prog1.0.0
DISTDIR = /home/dg/Projects/build-qFTDI_prog-Desktop-Debug/.tmp/qFTDI_prog1.0.0
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS) -lftdipp1 -lftdi1 -lusb-1.0 -lQt5Widgets -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
SOURCES       = ../qFTDI_prog/main.cpp \
		../qFTDI_prog/mainwindow.cpp \
		../qFTDI_prog/usbview.cpp moc_mainwindow.cpp
OBJECTS       = main.o \
		mainwindow.o \
		usbview.o \
		moc_mainwindow.o
DIST          = /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		...
		../qFTDI_prog/qFTDI_prog.pro ../qFTDI_prog/mainwindow.h \
		../qFTDI_prog/main.h ../qFTDI_prog/main.cpp \
		../qFTDI_prog/mainwindow.cpp \
		../qFTDI_prog/usbview.cpp
QMAKE_TARGET  = qFTDI_prog
DESTDIR       = 
TARGET        = qFTDI_prog
...
Makefile: ../qFTDI_prog/qFTDI_prog.pro /usr/lib64/qt5/mkspecs/linux-g++/qmake.conf /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib64/qt5/mkspecs/common/unix.conf \
		/usr/lib64/qt5/mkspecs/common/linux.conf \
		/usr/lib64/qt5/mkspecs/common/sanitize.conf \
		/usr/lib64/qt5/mkspecs/common/gcc-base.conf \
		...
		/usr/lib64/qt5/mkspecs/features/yacc.prf \
		/usr/lib64/qt5/mkspecs/features/lex.prf \
		../qFTDI_prog/qFTDI_prog.pro \
		/usr/lib64/libQt5Widgets.prl \
		/usr/lib64/libQt5Gui.prl \
		/usr/lib64/libQt5Core.prl
	$(QMAKE) -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ../qFTDI_prog/qFTDI_prog.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents ../qFTDI_prog/mainwindow.h ../qFTDI_prog/main.h $(DISTDIR)/
	$(COPY_FILE) --parents ../qFTDI_prog/main.cpp ../qFTDI_prog/mainwindow.cpp ../qFTDI_prog/usbview.cpp $(DISTDIR)/
	$(COPY_FILE) --parents ../qFTDI_prog/mainwindow.ui $(DISTDIR)/
...
moc_mainwindow.cpp: ../qFTDI_prog/main.h \
		../qFTDI_prog/mainwindow.h \
		moc_predefs.h \
		/usr/lib64/qt5/bin/moc
	/usr/lib64/qt5/bin/moc $(DEFINES) --include ./moc_predefs.h -I/usr/lib64/qt5/mkspecs/linux-g++ -I/home/dg/Projects/qFTDI_prog -I/usr/include/libftdi1 -I/usr/include/libusb-1.0 -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I. -I/usr/include/c++/6.3.1 -I/usr/include/c++/6.3.1/x86_64-redhat-linux -I/usr/include/c++/6.3.1/backward -I/usr/lib/gcc/x86_64-redhat-linux/6.3.1/include -I/usr/local/include -I/usr/include ../qFTDI_prog/mainwindow.h -o moc_mainwindow.cpp
...
ui_mainwindow.h: ../qFTDI_prog/mainwindow.ui \
		/usr/lib64/qt5/bin/uic
	/usr/lib64/qt5/bin/uic ../qFTDI_prog/mainwindow.ui -o ui_mainwindow.h
...
main.o: ../qFTDI_prog/main.cpp ../qFTDI_prog/mainwindow.h \
		../qFTDI_prog/main.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o ../qFTDI_prog/main.cpp

mainwindow.o: ../qFTDI_prog/mainwindow.cpp ../qFTDI_prog/mainwindow.h \
		../qFTDI_prog/main.h \
		ui_mainwindow.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o mainwindow.o ../qFTDI_prog/mainwindow.cpp

usbview.o: ../qFTDI_prog/usbview.cpp ../qFTDI_prog/mainwindow.h \
		../qFTDI_prog/main.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o usbview.o ../qFTDI_prog/usbview.cpp
